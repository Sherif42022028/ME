...
export const productSchema = z.object({
  ...
  price: z.coerce.number().positive("Price must be a positive number").default(40),
  costPrice: z.coerce.number().nonnegative("Cost price cannot be negative").default(15),

          ...
          <div className="relative">
            ...
            >
              ...
              <div className="hidden sm:block text-left">
                <p className="text-xs font-semibold text-white leading-tight">Micaela Ella</p>
            ...
            {userDropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-[#141414] border border-[#2a2a2a] rounded-xl shadow-2xl py-1 text-xs text-[#e5e5e5] z-50 animate-in fade-in zoom-in-95 duration-150">
                <div className="px-4 py-2 border-b border-[#222222]">
                  <p className="font-semibold text-white">Micaela Ella</p>
                  <p className="text-[10px] text-[#9ca3af]">micaela.ella.admin@gmail.com</p>
                </div>
                <button
                  onClick={() => {
